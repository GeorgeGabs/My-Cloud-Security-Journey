...
It is like renting an EMPTY apartment: Landlord provides Building, walls, doors, utilities;
...
RDS (Relational Database Service): MySQL, PostgreSQL, Oracle running; You don't manage the engine you just use it like a service.

Lambda (Serverless Functions): Write code, upload it and AWS runs it. You don't manage servers

Elastic Beanstalk: Upload your code, AWS deploys it and Auto scaling included

DynamoDB: NoSQL database, Fully managed; You store data, AWS manages it

### PaaS Analogy

It is like renting a FURNISHED apartment: Landlord provides Building, furniture, utilities;
You provide: Your belongings, decoration;
You don't maintain the furniture, Landlord handles repairs.
...
**Risk:**
If AWS has vulnerability: You're affected; but they usually patch fast and also limited control on timeline

If your app has vulnerability: You're at fault and You must fix it
...
Everything (servers, OS, app, security, backups, updates). Just works; No management needed

### What YOU Provide
Just use it, Provide your data and Pay the bill.

### Real SaaS Examples

Gmail: Google provides Everything;
You provide: Emails to write;
You manage: Your password, your contacts.

Slack: Slack provides Chat infrastructure, security, uptime
You provide: Team members, messages;
You manage: Your password, channel membership.

Microsoft 365 (Office): Microsoft provides Word, Excel, Office
You provide: Your documents;
You manage: Your password, sharing settings.

Salesforce: Salesforce provides CRM platform
...
It is like eating at a RESTAURANT: Restaurant provides Building, kitchen, chef, food, service;
...
If company gets hacked: Your data is exposed. You trust them, but you're at their mercy

If you use weak password: Hacker gets in, sees your data. Company's security doesn't matter if password is "123456"
...
IaaS: You control and manage everything. 
Responsibility: 80% you do most work, AWS help with severs, networks, etc
Complexity: HIGH

PaaS:You control 50%. you have somewhat shared responsibility with AWS
Responsibility: 50% you manage app/data and code
Complexity: MEDIUM

SaaS: The company controls basically everything, you just have to use the application.
...
4. **Choose based on needs** and not all applications fit one model
